...
python3 dynamics_modeling/ablations/train_deterministic.py data.same_grid=$same_grid data.sub_tr=$sub_tr data.sub_te=$sub_te wandb.checkpoint_path=$checkpoint_path optim.epochs=5000 optim.min_noise=1e-3
